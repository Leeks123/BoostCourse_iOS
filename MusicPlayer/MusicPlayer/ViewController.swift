...
//  MusicPlayer
//
//  Created by LeeKS on 2020/08/23.
...
//        self.addViewWithCode()
    ...
    func addTimeLabel(){
        ...
        top = timeLabel.topAnchor.constraint(equalTo:self.playPauseButton.bottomAnchor,constant: -40)
    ...
    func audioPlayerDecodeErrorDidOccur(_ player: AVAudioPlayer, error: Error?) {
        ...
        let message: String
        message = "오디오 에러 발생 \(error.localizedDescription)"
